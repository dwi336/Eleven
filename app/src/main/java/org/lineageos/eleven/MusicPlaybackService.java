...
public class MusicPlaybackService extends Service
    ...
    public void onCreate() {
        ...
        mNotificationManager = ContextCompat.getSystemService(this, NotificationManager.class);
    ...
    private void setUpMediaSession() {
        mAudioAttributes = new AudioAttributesCompat.Builder()
                ...
                .build();
        mAudioFocusRequest = new AudioFocusRequestCompat.Builder(AudioManagerCompat.AUDIOFOCUS_GAIN)
                .setAudioAttributes(mAudioAttributes)
                .setOnAudioFocusChangeListener(this, mPlayerHandler)
                .build();

        mSession = new MediaSessionCompat(this, "Eleven");
        mSession.setPlaybackToLocal(mAudioAttributes.getLegacyStreamType());
    ...
    private void setIsSupposedToBePlaying(boolean value, boolean notify) {
        if (mIsSupposedToBePlaying != value) {
            ...
            if (mIsSupposedToBePlaying) {
                ...
                ContextCompat.startForegroundService(this, new Intent(this, MusicPlaybackService.class));
            } else {
                scheduleDelayedShutdown();
    ...
    public void play(boolean createNewNextTrack) {
        int status = AudioManagerCompat.requestAudioFocus(mAudioManager, mAudioFocusRequest);
    ...
    private void startShakeDetector() {
        if (mShakeDetector != null) {
            mShakeDetector.start(ContextCompat.getSystemService(this, SensorManager.class));
        }
    }
    ...
    private static final class MultiPlayer implements MediaPlayer.OnErrorListener,
        ...
        public MultiPlayer(final MusicPlaybackService service, final Handler handler,
                           final AudioAttributesCompat attrs) {
            mService = new WeakReference<>(service);
            mHandler = handler;
        ...
        private boolean setDataSourceImpl(final MediaPlayer player, final String path) {
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
                    player.setAudioAttributes((AudioAttributes)mAudioAttributes.unwrap());
                } else {
