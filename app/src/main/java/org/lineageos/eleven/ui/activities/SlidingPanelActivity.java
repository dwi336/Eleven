...
public abstract class SlidingPanelActivity extends BaseActivity {
    ...
    private final ColorExtractor.Callback mColorExtractorCallback = new ColorExtractor.Callback(){
        public final void onColorExtracted(BitmapWithColors bitmapWithColors) {
