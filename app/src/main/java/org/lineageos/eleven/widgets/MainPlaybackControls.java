...
public class MainPlaybackControls extends FrameLayout {
    ...
    public MainPlaybackControls(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        previousButton.setRepeatListener(new RepeatingImageButton.RepeatListener(){
            @Override
            public final void onRepeat(View v, long delta, int repeatCount) {
                seekRelative(repeatCount, delta, false);
            }
        });
        nextButton.setRepeatListener(new RepeatingImageButton.RepeatListener(){
            @Override
            public final void onRepeat(View v, long delta, int repeatCount) {
                seekRelative(repeatCount, delta, true);
            }
        });
